...
?>
    <main>
        ...
        <ul>
          ...
          <li>
           ...
           <li>
            ...
            <input type="text" name="telefone" id="telefone" placeholder="Telefone" required maxlength="255" value="<?php echo htmlspecialchars( $row['telefone'] )?>" />
          </li>
        ...
        <div class="buttons">
          <input type="submit" name="saveChanges" value="New contact information" />
