...
<?php
$news = trim(htmlspecialchars(mysqli_real_escape_string($conn, $_POST['item'])));
...
{ ?>
     <div class="grid_4">
                    <div class="img">
                        <div class="lazy-img" style="padding-bottom: 76.21621621621622%;"> <a href="changenewsimage.php?id=<?php echo $row['ID']; ?>&news=<?php echo $news; ?>">
